...
def main():
    Input = int(input(("Enter a positive integer: "))) #Askes user for inputs
   
    while Input>0:
        for limit in range(is_prime(Input),Input): #It is prime i the input is greather than 0
            print(f"The primes up to 101 are:{range(is_prime(Input),Input)}")
